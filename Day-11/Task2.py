'''Creating a python program to get pull reuqest information for a specifc git hub repo (Kubernetes)
and get how many pull requests done by each user for kubernetes'''

#To connect with kubernetes repo we can use python requests module to connect with api
import requests
